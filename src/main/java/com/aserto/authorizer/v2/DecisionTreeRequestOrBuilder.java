...
public interface DecisionTreeRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:aserto.authorizer.v2.DecisionTreeRequest)
   ...
   * @return The options.
   */
  com.aserto.authorizer.v2.DecisionTreeOptions getOptions();
  /**
   * <code>.aserto.authorizer.v2.DecisionTreeOptions options = 3 [json_name = "options"];</code>
   */
  com.aserto.authorizer.v2.DecisionTreeOptionsOrBuilder getOptionsOrBuilder();
